...
class TestPortalThinkingReplay:
    ...
    def test_other_third_party_gateways_also_keep_signed_thinking(self):
        """Intact thinking replay is independent of endpoint identity."""
        self._assert_thinking_kept("https://api.minimax.io/anthropic")
